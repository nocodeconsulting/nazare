      ...
      <div className="container mx-auto py-12 md:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="flex flex-col h-[500px]">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 font-sans">NAZARÉ Essentials</h2>
            <iframe
          ...
          <div className="flex flex-col h-[500px]">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 font-sans">Recently Added</h2>
            <iframe
              allow="autoplay *; encrypted-media *; fullscreen *; clipboard-write"
              frameBorder="0"
              height="100%"
